...
public class SecurityConfig {
    ...
    @Value("${finova.security.public-paths:/actuator/**,/api/planning/health,/error}")
                ...
                .authorizeHttpRequests(authz -> {
                    if (oauthEnabled && isOAuthConfigured()) {
                        ...
                        authz
                            ...
                            .requestMatchers(new AntPathRequestMatcher("/api/auth/health"), new AntPathRequestMatcher("/api/planning/health")).permitAll()
                            .requestMatchers(new AntPathRequestMatcher("/h2-console/**")).permitAll() // For development
                            
                            // Planning endpoints require authentication
                            .requestMatchers(new AntPathRequestMatcher("/api/planning/**")).authenticated()
